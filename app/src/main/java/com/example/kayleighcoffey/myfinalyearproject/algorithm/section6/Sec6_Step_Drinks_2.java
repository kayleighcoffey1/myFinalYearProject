...
import com.example.kayleighcoffey.myfinalyearproject.algorithm.First_Step_Mood;
...
public class Sec6_Step_Drinks_2 extends AppCompatActivity
{
    ...
    public void myDrinks(){
        ...
        myRef.child("personal_logs").child("drink_logs").child("log").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(countdrinks == 0 )
                {
                    System.out.println("enough sleep, enough exercise and no caffine/alcohol could of had a positive effect");
                    resulttext.setText("enough sleep, enough exercise and no caffine/alcohol could of had a positive effect");
                }
                ...
                {
                    System.out.println("enough sleep, enough exercise could of had a positive effect");
                    resulttext.setText("enough sleep, enough exercise could of had a positive effect");
                }
