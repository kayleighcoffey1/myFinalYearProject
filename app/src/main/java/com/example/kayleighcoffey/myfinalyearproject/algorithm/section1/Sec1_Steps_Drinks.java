...
public class Sec1_Steps_Drinks extends AppCompatActivity
{
    ...
    public void myDrinks(){
        ...
        myRef.child("personal_logs").child("drink_logs").child("log").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(countdrinks == 0 )
                {
                    System.out.println("No exercise and not enough sleep");
                    resulttext.setText("No exercise and not enough sleep");
                ...
                {
                    // user drank more than recommended amount for a single day
                    System.out.println("No exercise, not enough sleep, too much caffine/alcohol");
                    resulttext.setText("No exercise and not enough sleep, too much caffine/alcohol");
