...
/**
 * CLASS TAKES IN DRINKS
 */

public class Sec3_Steps_Drinks extends AppCompatActivity
{
    ...
    public void myDrinks(){
        ...
        myRef.child("personal_logs").child("drink_logs").child("log").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                {
                    System.out.println("Not enough Sleep, not enough exercise and too much caffine/alcohol");
                    resulttext.setText("Not enough sleep, not enough exercise and too much caffine/alcohol");
