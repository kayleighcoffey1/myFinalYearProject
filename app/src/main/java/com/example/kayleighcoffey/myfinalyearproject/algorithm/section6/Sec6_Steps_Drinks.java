...
public class Sec6_Steps_Drinks extends AppCompatActivity
{
    ...
    public void myDrinks(){
        ...
        myRef.child("personal_logs").child("drink_logs").child("log").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(countdrinks == 0 )
                {
                    System.out.println("Not enough sleep did not affect your mood");
                    resulttext.setText("Not enough sleep did not affect your mood");
                }
                ...
                {
                    System.out.println("Not enough sleep and drinking too much caffine/alcohol did not affect mood");
                    resulttext.setText("Not enough sleep and drinking too much caffine/alcohol did not affect mood");
                }
