...
public class Sec3_Step_Drinks_2 extends AppCompatActivity
{
        ...
        myRef.child("personal_logs").child("drink_logs").child("log").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(countdrinks == 0 ) {
                    ...
                    resulttext.setText("No exercise could be affecting mood");
                }
                ...
                {
                    System.out.println("not enough exercise and too much caffine/alcohol");
                    resulttext.setText("Not enough exercise and too much caffine/alcohol could be affecting mood");
